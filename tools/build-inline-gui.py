...
sources=['gui/main.cpp','gui/mainwindow.cpp','gui/inline_nr_panel.cpp','gui/passdialog.cpp','gui/shm_binder.cpp','layer_linux/src/hotkey.cpp','common/runner_discovery.cpp']
...
sources+=['test_gui/inline_panel_test.cpp','test_gui/binder_test.cpp']
def compile(source):
